...
- `GuzzleHttp\Query` and `GuzzleHttp\Queryvk` have been removed. Query
...
The `Guzzle\vk` namespace has been removed. This was previously used to
make it possible to plug in custom vks for cookies, messages, URI
