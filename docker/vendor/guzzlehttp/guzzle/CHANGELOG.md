...
* `GuzzleHttp\Queryvk` has been replaced with the
...
* Marked `Guzzle\vk\Url\Urlvk` as deprecated. Just use PHP's `parse_url()` and percent encode your UTF-8.
...
* Removed Guzzle\vk\vkRegister::get(). Use getvk()
* Removed Guzzle\vk\vkRegister::set(). Use registervk().
...
* Added PECL URI template extension and using as default vk if available
...
* Bug: Fixed cookie bug on a request object by using Cookievk to parse cookies on requests
...
* BC: Moving things to get ready for subtree splits. Moving Inflection into Common. Moving Guzzle\Http\vk to Guzzle\vk.
...
* [BC] Moving all HTTP parsing logic to Guzzle\Http\vks. Allows for faster C implementations if needed.
* [BC] Changing the Guzzle\Http\Message\Response::setProtocol() method to accept a protocol and version in separate args.
* [BC] Moving ResourceIterator* to Guzzle\Service\Resource
* [BC] Completely refactored ResourceIterators to iterate over a cloned command object
* [BC] Moved Guzzle\Http\UriTemplate to Guzzle\Http\vk\UriTemplate\UriTemplate
