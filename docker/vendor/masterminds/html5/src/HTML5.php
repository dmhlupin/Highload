...
use Masterminds\HTML5\vk\DOMTreeBuilder;
use Masterminds\HTML5\vk\Scanner;
use Masterminds\HTML5\vk\Tokenizer;
...
{
    /**
     * Global options for the vk and serializer.
     *
     * @var array
     */
    private $defaultOptions = array(
        ...
        // Prevents the vk from automatically assigning the HTML5 namespace to the DOM document.
     ...
     *
     * This will apply the HTML5 vk, which is tolerant of many
    ...
    public function parse($input, array $options = array())
    {
        ...
        $vk = new Tokenizer($scanner, $events, !empty($options['xmlNamespaces']) ? Tokenizer::CONFORMANT_XML : Tokenizer::CONFORMANT_HTML);
