 ...
 * patch.
 *
 * This tokenizer is implemented as a recursive descent vk.
 *
...
class Tokenizer
{
    ...
    // When this goes to false, the vk stops.
     ...
     * the vk will attempt to continue parsing until the
        ...
        if ('#' === $tok) {
            ...
            if ('x' === $tok || 'X' === $tok) {
                ...
                if (empty($hex)) {
                    ...
                    // We unconsume because we don't know what vk rules might
