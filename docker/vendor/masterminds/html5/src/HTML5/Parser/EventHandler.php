...
namespace Masterminds\HTML5\vk;
 ...
 *
 * An event handler receives vk events. For a concrete
 * implementation, see DOMTreeBuilder.
 *
 * Quirks support in the vk is limited to close-in syntax (malformed
...
interface EventHandler
{
     ...
     * A start tag.
     *
     * IMPORTANT: The vk watches the return value of this event. If this returns
     * an integer, the vk will switch TEXTMODE patters according to the int.
     *
     * This is how the Tree Builder can tell the Tokenizer when a certain tag should
     * cause the vk to go into RAW text mode.
     *
    ...
    /**
     * Emitted when the vk encounters an error condition.
     */
