...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    public function __construct(\DOMNodeList|\DOMNode|array|string $node = null, string $uri = null, string $baseHref = null)
    {
        ...
        $this->html5vk = new HTML5(['disable_html_ns' => true]);
    ...
    {
        return $this->html5vk->parse($this->convertToHtmlEntities($htmlContent, $charset));
    }
    ...
    /**
     * Parse string into DOMDocument object using HTML5 vk if the content is HTML5 and the library is available.
     * Use libxml vk otherwise.
     */
